...
app_ui = ui.page_fluid(
    ...
    ui.layout_sidebar(
        ui.panel_sidebar(
            ...
            #     ),
            #     ui.input_numeric(
            #         "wavelet_sigma", "Sigma reduction", min=0, max=10, step=1, value=2
            #     ),
            #     ui.input_slider(
            #         "wavelet_levels", "Wavelet levels", min=1, max=10, value=5
            #     ),
            #     ui.input_checkbox("wavelet_rescale", "Rescale sigma", value=True),
            # ),
            ui.div(
        ...
        if input.denoise_method() is not None and img_original_path.get() is not None:
            ...
            args = {
                ...
                "wavelet": {
                    ...
                    "wavelet_levels": input.wavelet_wavelet_levels(),
                    "rescale_sigma": input.wavelet_rescale_sigma(),
                    "sigma_reduction": input.wavelet_sigma_reduction(),
                },
            }
